...
PURCHASE_PRICE = 150000 # USER_INPUT

DOWNPAY_PERCENT = 20.0/100 # USER_INPUT, DEFAULT: 20%
DOWNPAY = PURCHASE_PRICE * DOWNPAY_PERCENT

EST_CLOSING_COST = 2.0/100 * PURCHASE_PRICE # USER_INPUT, DEFAULT: 2% * purchase_price
...
EST_MORTGAGE_LOAN_APR = 4.5/100 # USER_INPUT, DEFAULT: 4.5%
...
# == tax/out-of-pocket ==
PROPERTY_TAX_RATE = 0.8/100 # USER_INPUT, DEFAULT: 8%
...
EST_ANNUAL_HOME_INSURANCE_EXPENSE = 0.05/100 * PURCHASE_PRICE # USER_INPUT, DEFAULT: 0.5% * purchase_price

EST_ANNUAL_REPAIR_RESERVE_EXPENSE = 1.0/100 * PURCHASE_PRICE # ??? USER_INPUT, DEFAULT: 1% * purchase_price
...
# == income/into-pocket ==
EST_MONTHLY_RENT = 1400 # USER_INPUT

EST_VACANCY_PERCENT = 8.0/100 # USER_INPUT, DEFAULT: 8%

EST_ANNUAL_GROSS_INCOME = EST_MONTHLY_RENT * MONS_PER_YR * (1 - EST_VACANCY_PERCENT)


# == service/out-of-pocket ==
EST_ANNUAL_PROPERTY_MANAGER_SERVICE_FEE_RATE = 12.0/100 # USER_INPUT, DEFAULT: 12%
...
def main():
    ...
    print "EST_MONTHLY_RENT: $%d" % EST_MONTHLY_RENT
